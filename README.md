...
- Async Storage
  ...
  - **NOTA**
    - _ASYNC_, No esta funcionando para versión de React > a la **0.72**
...
3. Es el sustituto de lo que antes era: componentDidMount() y: componentDidUpdate()
4. Al ejecutarse automaticamente cuando el componente esta listo, es un excelente lugar para colocar código para consultar una API o LocalStorage.
5. Debido a que le podemos pasar una dependencia y estar escuchando por los cambios que sucendan en una variable, puede actualizar el componente cuando ese cambio suceda.
